...
<span  class="dclabel">Auteur<!--  (DC.Creator) --> : <?php echo metadata('file', array('Dublin Core', 'Creator'), array('delimiter' => ' ; '));?></span><br />

<?php echo get_specific_plugin_hook_output('Coins', 'public_files_show', array('view' => $this, 'file' => $file));?>
	
<?php echo $content; ?>

<span class="dclabel" style="clear:both;display:block;float:right;">Fichier cr&eacute;&eacute; le <?php echo date('d/m/Y', strtotime(metadata('file', 'added'))); ?> </br ></br ></span>
...
// 		echo "fichier : " . $fichier->id . " / i = $i / maxFiles = $maxFiles / start = $start";    
  ...
  $pager = "<div id='eman-pager-files'><h3>Autres fichiers de la notice</h3>" . $prec . implode('<div class="eman-files-sep"> | </div>', $pager) . $suiv . "</div>";
